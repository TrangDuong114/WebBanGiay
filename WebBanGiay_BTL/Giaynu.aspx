<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Giaynu.aspx.cs" Inherits="WebBanGiay_BTL.Giaynu" %>
...
<body>
    <form id="form1" runat="server">
       ...
       <div class="up">
        <div class="abc">
            <a href="Trangchu.aspx"><strong>TRANG CHỦ</strong></a> / <a href="Giaynu.aspx"><strong>GIÀY NỮ</strong></a>
        </div>
    </div>
    <div class="container">
        ...
        <div class="sidebar_two">
            <div class="sanpham">
                <asp:ListView ID="giaynu1" runat="server">
                    <ItemTemplate>
